    ...
    <section id="pricing" className="py-24 bg-white dark:bg-slate-950">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-sm mx-auto mb-10">
          ...
          {/* 전체 묶음 — 추천 */}
          <div className="relative rounded-2xl border-2 border-blue-500 dark:border-blue-400 bg-white dark:bg-slate-900 p-7 flex flex-col hover:-translate-y-0.5 transition-transform duration-200 overflow-hidden">
            {/* 상단 그라데이션 바 */}
            ...
            <div className="mb-6">
              ...
              <div className="flex items-baseline gap-1.5 mb-1">
                <span className="text-4xl font-black text-blue-600 dark:text-blue-400">19만원</span>
